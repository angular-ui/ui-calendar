            ...
            this.changeWatcher = function (arraySource, tokenFn) {
                ...
                return self = {
                    subscribe: function (scope, onArrayChanged) {
                        scope.$watch(
                            getTokens, function (newTokens, oldTokens) {
            ...
            return {
                ...
                link: function (scope, elm, attrs, controller) {
                    ...
                    scope.destroyCalendar = function () {
                        ...
                        if (attrs.calendar && uiCalendarConfig.calendars[attrs.calendar]) {
                    ...
                    scope.$watch(
                        getOptions, function (newValue, oldValue) {
